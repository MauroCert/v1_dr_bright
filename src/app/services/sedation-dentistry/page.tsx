...
const sedationOptions = [
  {
    ...
    description: 'Nitrous oxide is a mild, fast-acting sedative inhaled through a small mask over your nose. It helps you feel relaxed and comfortable while remaining fully conscious. Effects wear off within minutes after the mask is removed.',
    listTitle: 'Benefits include:',
    points: ['Takes effect in minutes', 'Adjustable throughout procedure', 'Wears off quickly', 'Safe for most patients'],
    image: '/Main service page/european-mid-pleased-dentist-woman-face-mask-working-dental-clinic.jpg',
  },
  {
    title: 'Oral Sedation',
    description: 'For patients who need a deeper level of relaxation, oral sedation involves taking a prescribed medication before your appointment. You will feel drowsy and deeply relaxed but can still respond to instructions.',
    listTitle: 'Ideal for:',
    points: ['Moderate dental anxiety', 'Longer procedures', 'Sensitive gag reflex', 'Multiple treatments in one visit'],
    note: 'You will need someone to drive you to and from your appointment when receiving oral sedation.',
    image: '/Individual service page/Hero.jpg',
  },
  {
    title: 'Comfort Amenities',
    description: 'Beyond sedation, we offer a range of comfort options to make your visit as pleasant as possible. Our calming atrium environment, weighted blankets, curated playlists, and beverage station help ease anxiety before you even sit in the chair.',
    listTitle: 'Amenities include:',
    points: ['Weighted blankets', 'Noise-canceling headphones', 'Curated playlists', 'Beverage station'],
...
const candidateReasons = [
  {
    title: 'Dental Anxiety or Fear',
    description: 'If past experiences or general fear keeps you from the dentist, sedation can help you feel safe and relaxed.',
  },
  {
    title: 'Sensitive Teeth or Gag Reflex',
    description: 'Sedation reduces sensitivity and helps manage a strong gag reflex for a more comfortable experience.',
  },
  {
    title: 'Complex or Lengthy Procedures',
    description: 'For treatments that require extended time, sedation helps you stay comfortable throughout.',
  },
  {
    title: 'Special Needs Patients',
    description: 'We accommodate patients with physical, cognitive, or sensory needs with personalized sedation plans.',
  },
];
...
const faqs = [
  {
    ...
    answer: 'Yes. Dr. Bright is trained in all sedation methods we offer, and we monitor your vitals throughout the procedure. We review your medical history thoroughly to ensure the chosen sedation method is safe for you.',
  },
  {
    question: 'Will I be unconscious during sedation?',
    answer: 'With nitrous oxide and oral sedation, you remain conscious but deeply relaxed. You can still respond to instructions and communicate with Dr. Bright throughout the procedure.',
  },
  {
    question: 'How long do the effects last?',
    answer: 'Nitrous oxide wears off within 5–10 minutes after the mask is removed. Oral sedation effects may last several hours, which is why you need a designated driver.',
  },
  {
    question: 'Can children receive sedation?',
    answer: 'Yes. Nitrous oxide is commonly used for children and is very safe. Dr. Bright will discuss the best options based on your child\'s age, needs, and the procedure being performed.',
  },
  {
    question: 'Does insurance cover sedation dentistry?',
    answer: 'Coverage varies by plan and the reason for sedation. We will help verify your benefits and discuss out-of-pocket costs before your appointment.',
  },
];
    ...
    <div className="bg-white">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center">
        <div className="absolute inset-0">
          <Image
            src="/Main service page/Copy of Sedation Dentistry.jpg"
            alt="Sedation Dentistry at Cherry Creek South Dental"
            fill
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight text-white mb-6">
            Relaxed, <span className="text-[var(--gold)]">Comfortable</span> Dentistry
          </h1>
          <p className="text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Overcome dental anxiety with gentle sedation options and a calming environment designed for your comfort.
          </p>
          <a
            href="tel:3033777744"
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative h-[450px] overflow-hidden shadow-lg">
              <Image src="/Individual service page/What your general dentistry visit feels like.jpg" alt="Comfortable dental environment" fill className="object-cover" />
            </div>
            <div className="space-y-6">
              <h2 className="text-3xl sm:text-4xl font-bold text-[var(--navy)]">Why Choose Sedation Dentistry?</h2>
              <ul className="space-y-4">
                <li className="flex items-start gap-4">
                  ...
                  <div><h3 className="font-semibold text-[var(--navy)]">Anxiety-Free Experience</h3><p className="text-gray-600 text-sm">Feel calm and relaxed throughout your entire visit</p></div>
                </li>
                <li className="flex items-start gap-4">
                  ...
                  <div><h3 className="font-semibold text-[var(--navy)]">Safe & Monitored</h3><p className="text-gray-600 text-sm">Your vitals are continuously monitored for complete safety</p></div>
                </li>
                <li className="flex items-start gap-4">
                  ...
                  <div><h3 className="font-semibold text-[var(--navy)]">More Done Per Visit</h3><p className="text-gray-600 text-sm">Complete multiple treatments in a single comfortable appointment</p></div>
                </li>
                <li className="flex items-start gap-4">
                  ...
                  <div><h3 className="font-semibold text-[var(--navy)]">Calming Environment</h3><p className="text-gray-600 text-sm">Our atrium with plants and natural light reduces anxiety naturally</p></div>
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="py-24 bg-[#f5f5f5] -mt-1">
        <div className="mx-auto max-w-6xl px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-[var(--navy)] mb-4">Our Sedation & Comfort Options</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">Multiple levels of relaxation tailored to your needs</p>
          </div>
          <div className="space-y-16">
            {sedationOptions.map((option, index) => (
              <div key={option.title} className="bg-white shadow-sm overflow-hidden">
                <div className={`grid lg:grid-cols-2 ${index % 2 === 1 ? 'lg:flex-row-reverse' : ''}`}>
                  ...
                  <div className={`p-8 lg:p-10 flex flex-col justify-center ${index % 2 === 1 ? 'lg:order-1' : 'lg:order-2'}`}>
                    <h3 className="text-2xl font-bold text-[var(--navy)] mb-4">{option.title}</h3>
                    <p className="text-gray-600 leading-relaxed mb-6">{option.description}</p>
                    <div>
                      <p className="font-semibold text-[var(--navy)] mb-3">{option.listTitle}</p>
                    ...
                    {option.note && (
                      <p className="text-gray-500 italic border-l-4 border-[var(--gold)] pl-4 mt-6 text-sm">{option.note}</p>
                    )}
                  </div>
                </div>
              </div>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative h-[400px] rounded-lg overflow-hidden shadow-lg">
              <Image src="/Main service page/orthodontist-with-latex-glove-handling-dental-equipment.jpg" alt="Sedation consultation" fill className="object-cover" />
            ...
            <div className="space-y-6">
              <h2 className="text-3xl sm:text-4xl font-bold text-[var(--navy)]">Is Sedation Dentistry Right for You?</h2>
              <p className="text-gray-600">Sedation may be a great option if you experience any of the following:</p>
              <div className="space-y-4">
                {candidateReasons.map((reason, index) => (
                  <div key={reason.title} className="flex gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-[var(--navy)]">{reason.title}</h3>
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Link href="/services/general-dentistry" className="group border border-[var(--gold)]/40 bg-[#faf9f7] p-8 text-center hover:border-[var(--gold)] hover:shadow-lg transition-all">
              ...
              <p className="text-gray-600 leading-relaxed text-sm">Preventive care in a calm, unhurried environment.</p>
            </Link>
            <Link href="/services/cosmetic-dentistry" className="group border border-[var(--gold)]/40 bg-[#faf9f7] p-8 text-center hover:border-[var(--gold)] hover:shadow-lg transition-all">
              ...
              <p className="text-gray-600 leading-relaxed text-sm">Transform your smile with sedation-assisted cosmetic treatments.</p>
            </Link>
            <Link href="/services/extractions" className="group border border-[var(--gold)]/40 bg-[#faf9f7] p-8 text-center hover:border-[var(--gold)] hover:shadow-lg transition-all">
              ...
              <h3 className="text-lg font-bold text-[var(--navy)] mb-4 leading-snug uppercase tracking-wide">Extractions</h3>
              <p className="text-gray-600 leading-relaxed text-sm">Gentle tooth removal with sedation for maximum comfort.</p>
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-8">Ready to experience anxiety-free dentistry? Contact us to discuss sedation options with Dr. Bright.</p>
