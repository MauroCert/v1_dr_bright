...
import { ArrowRight, CheckCircle2, Sparkles, Heart, Shield, Clock, Phone, MapPin, Smile } from 'lucide-react';

const extractionTypes = [
  {
    title: 'Simple Extractions',
    description: 'Simple extractions are performed on teeth that are visible and accessible. Using local anesthesia, Dr. Bright gently loosens and removes the tooth with minimal discomfort. Most patients are surprised by how smooth the process is.',
    listTitle: 'Common reasons:',
    points: ['Severely decayed teeth', 'Loose teeth from gum disease', 'Crowded teeth before orthodontics', 'Fractured teeth beyond repair'],
    image: '/Main service page/european-mid-pleased-dentist-woman-face-mask-working-dental-clinic.jpg',
  },
  {
    title: 'Surgical Extractions',
    description: 'Surgical extractions are needed for teeth that are impacted, broken below the gum line, or have complex root structures. Dr. Bright uses advanced imaging and gentle technique to minimize tissue disruption.',
    listTitle: 'Surgical cases include:',
    points: ['Impacted wisdom teeth', 'Broken roots below gum line', 'Teeth fused to bone', 'Complex multi-rooted teeth'],
    note: 'Sedation options are available for all surgical extractions to ensure your complete comfort.',
    image: '/Individual service page/Hero.jpg',
  },
  {
    title: 'Wisdom Teeth Removal',
    description: 'Wisdom teeth often lack space to emerge properly, leading to impaction, crowding, or infection. We coordinate removal with your comfort and recovery in mind, providing detailed aftercare instructions.',
    listTitle: 'Signs you may need removal:',
    points: ['Jaw pain or stiffness', 'Swollen or bleeding gums', 'Difficulty opening your mouth', 'Recurring infections'],
    image: '/Main service page/orthodontist-with-latex-glove-handling-dental-equipment.jpg',
  },
  {
    title: 'Pre-Prosthetic Extractions',
    description: 'Sometimes teeth need to be removed before placing dentures, implants, or other restorations. We plan these extractions carefully to preserve bone and prepare for the best possible outcome.',
    listTitle: 'Followed by:',
    points: ['Dental implants', 'Bridges', 'Dentures', 'Bone grafting if needed'],
...
const aftercareSteps = [
  {
    ...
    description: 'Bite on gauze for 30–45 minutes. Apply ice packs to reduce swelling. Rest and keep your head elevated.',
  },
  {
    title: 'First 24 Hours',
    description: 'Avoid straws, spitting, and rinsing. Eat soft foods. Take prescribed medications as directed.',
  },
  {
    title: 'Days 2–3',
    description: 'Begin gentle salt-water rinses. Continue soft foods. Swelling peaks then begins to subside.',
  },
  {
    title: 'Follow-Up Visit',
    description: 'Dr. Bright checks your healing, removes any sutures if needed, and discusses next steps for tooth replacement.',
  },
];
...
const faqs = [
  {
    ...
    answer: 'You should not feel pain during the procedure thanks to local anesthesia. You may feel pressure or movement, but not pain. Sedation options are available for additional comfort. Post-operative soreness is typically mild and manageable.',
  },
  {
    question: 'How long does recovery take?',
    answer: 'Most patients recover within 3–7 days for simple extractions and 7–14 days for surgical extractions. You can usually return to normal activities within 1–2 days, though you should avoid strenuous exercise for a few days.',
  },
  {
    question: 'Do I need to replace an extracted tooth?',
    answer: 'In most cases, yes. Missing teeth can cause neighboring teeth to shift, bone loss, and bite problems. Dr. Bright will discuss replacement options like implants, bridges, or dentures during your consultation.',
  },
  {
    question: 'What about my wisdom teeth?',
    answer: 'Not everyone needs wisdom teeth removed. Dr. Bright evaluates your specific situation with X-rays and clinical examination to determine if removal is necessary based on impaction, crowding, or infection risk.',
  },
  {
    question: 'Can I eat after an extraction?',
    answer: 'Stick to soft, cool foods for the first 24–48 hours. Good options include yogurt, smoothies (without straws), mashed potatoes, and scrambled eggs. Gradually return to normal foods as comfort allows.',
  },
];
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Tooth Extractions at Cherry Creek South Dental"
            fill
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight text-white mb-6">
            Gentle <span className="text-[var(--gold)]">Extractions</span>
          </h1>
          <p className="text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Simple and surgical extractions performed with extended appointment times, gentle technique, and your comfort as the priority.
          </p>
          <a
            href="tel:3033777744"
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative h-[450px] overflow-hidden shadow-lg">
              <Image src="/Individual service page/What your general dentistry visit feels like.jpg" alt="Gentle extraction procedure" fill className="object-cover" />
            </div>
            <div className="space-y-6">
              <h2 className="text-3xl sm:text-4xl font-bold text-[var(--navy)]">Why Choose Dr. Bright for Extractions?</h2>
              <ul className="space-y-4">
                <li className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-[var(--gold)]/10 flex items-center justify-center flex-shrink-0 mt-0.5"><Heart className="h-5 w-5 text-[var(--gold)]" /></div>
                  <div><h3 className="font-semibold text-[var(--navy)]">Gentle Technique</h3><p className="text-gray-600 text-sm">Minimally invasive approach that preserves surrounding bone and tissue</p></div>
                </li>
                <li className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-[var(--gold)]/10 flex items-center justify-center flex-shrink-0 mt-0.5"><Shield className="h-5 w-5 text-[var(--gold)]" /></div>
                  <div><h3 className="font-semibold text-[var(--navy)]">Sedation Available</h3><p className="text-gray-600 text-sm">Nitrous oxide and oral sedation for anxiety-free extractions</p></div>
                </li>
                <li className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-[var(--gold)]/10 flex items-center justify-center flex-shrink-0 mt-0.5"><Sparkles className="h-5 w-5 text-[var(--gold)]" /></div>
                  <div><h3 className="font-semibold text-[var(--navy)]">Advanced Imaging</h3><p className="text-gray-600 text-sm">CBCT and digital X-rays for precise treatment planning</p></div>
                </li>
                <li className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-[var(--gold)]/10 flex items-center justify-center flex-shrink-0 mt-0.5"><Clock className="h-5 w-5 text-[var(--gold)]" /></div>
                  <div><h3 className="font-semibold text-[var(--navy)]">Extended Appointments</h3><p className="text-gray-600 text-sm">No rushing—we take the time needed for a thorough, comfortable procedure</p></div>
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="py-24 bg-[#f5f5f5] -mt-1">
        <div className="mx-auto max-w-6xl px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-[var(--navy)] mb-4">Types of Extractions We Perform</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">Every extraction is planned carefully for the best outcome</p>
          </div>
          <div className="space-y-16">
            {extractionTypes.map((type, index) => (
              <div key={type.title} className="bg-white shadow-sm overflow-hidden">
                <div className={`grid lg:grid-cols-2 ${index % 2 === 1 ? 'lg:flex-row-reverse' : ''}`}>
                  ...
                  <div className={`p-8 lg:p-10 flex flex-col justify-center ${index % 2 === 1 ? 'lg:order-1' : 'lg:order-2'}`}>
                    <h3 className="text-2xl font-bold text-[var(--navy)] mb-4">{type.title}</h3>
                    <p className="text-gray-600 leading-relaxed mb-6">{type.description}</p>
                    <div>
                      <p className="font-semibold text-[var(--navy)] mb-3">{type.listTitle}</p>
                    ...
                    {type.note && (
                      <p className="text-gray-500 italic border-l-4 border-[var(--gold)] pl-4 mt-6 text-sm">{type.note}</p>
                    )}
                  </div>
                </div>
              </div>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative h-[400px] rounded-lg overflow-hidden shadow-lg">
              <Image src="/Main service page/european-mid-pleased-dentist-woman-face-mask-working-dental-clinic.jpg" alt="Post-extraction care" fill className="object-cover" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent" />
              <div className="absolute bottom-8 left-8 right-8 text-white">
                <p className="text-2xl font-bold">Guided recovery for optimal healing</p>
              </div>
            </div>
            <div className="space-y-6">
              <h2 className="text-3xl sm:text-4xl font-bold text-[var(--navy)]">Aftercare & Recovery</h2>
              <p className="text-gray-600">We guide you through every step of your recovery:</p>
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Link href="/services/restorative-dentistry" className="group border border-[var(--gold)]/40 bg-[#faf9f7] p-8 text-center hover:border-[var(--gold)] hover:shadow-lg transition-all">
              ...
              <p className="text-gray-600 leading-relaxed text-sm">Replace extracted teeth with long-lasting, natural-looking implants.</p>
            </Link>
            <Link href="/services/sedation-dentistry" className="group border border-[var(--gold)]/40 bg-[#faf9f7] p-8 text-center hover:border-[var(--gold)] hover:shadow-lg transition-all">
              ...
              <p className="text-gray-600 leading-relaxed text-sm">Comfort options for anxiety-free extraction procedures.</p>
            </Link>
            <Link href="/services/general-dentistry" className="group border border-[var(--gold)]/40 bg-[#faf9f7] p-8 text-center hover:border-[var(--gold)] hover:shadow-lg transition-all">
              ...
              <p className="text-gray-600 leading-relaxed text-sm">Preventive care to help you keep your natural teeth longer.</p>
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-8">Need an extraction or have questions? Contact us to schedule a consultation with Dr. Bright.</p>
