...
import { ArrowRight, Heart, Clock, Sparkles, Shield, Star, Phone, MapPin } from 'lucide-react';
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center">
        <div className="absolute inset-0">
          <Image
            ...
            alt="About Cherry Creek South Dental"
            fill
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight text-white mb-6">
            About <span className="text-[var(--gold)]">Cherry Creek South</span> Dental
          </h1>
          <p className="text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            A family-owned practice committed to exceptional care in a warm, welcoming environment where every patient feels valued.
          </p>
          <a
            href="tel:3033777744"
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              <h2 className="text-3xl sm:text-4xl font-bold text-[var(--navy)]">Our Story</h2>
              <p className="text-gray-600 leading-relaxed">
                Cherry Creek South Dental was founded with a simple mission: to provide dental care that feels different from the typical corporate dental experience. As a family-owned practice, we believe in building lasting relationships with our patients based on trust, transparency, and genuine care.
              </p>
              <p className="text-gray-600 leading-relaxed">
                What sets us apart is our commitment to spending quality time with each patient. We schedule longer appointments than most practices, ensuring that every procedure is done thoroughly and without rushing. This patient-first approach, combined with our integration of advanced technology like AI-powered X-rays, allows us to provide the highest quality care.
              </p>
              <p className="text-gray-600 leading-relaxed">
                Our office features a calming atrium with plants and natural light, creating a relaxing environment that helps reduce dental anxiety. Every member of our team is dedicated to making your dental experience as comfortable and positive as possible.
              </p>
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="group border border-[var(--gold)]/40 bg-[#faf9f7] p-8 text-center hover:border-[var(--gold)] hover:shadow-lg transition-all">
              ...
              <h3 className="text-lg font-bold text-[var(--navy)] mb-4 leading-snug uppercase tracking-wide">Patient-Centered Care</h3>
              <p className="text-gray-600 leading-relaxed text-sm">Every treatment plan is tailored to your individual needs and comfort.</p>
            </div>
            <div className="group border border-[var(--gold)]/40 bg-[#faf9f7] p-8 text-center hover:border-[var(--gold)] hover:shadow-lg transition-all">
              <div className="w-16 h-16 mx-auto mb-6 rounded-full bg-[var(--navy)] flex items-center justify-center">
                <Clock className="w-8 h-8 text-white" strokeWidth={1.5} />
              </div>
              <h3 className="text-lg font-bold text-[var(--navy)] mb-4 leading-snug uppercase tracking-wide">Quality Time</h3>
              <p className="text-gray-600 leading-relaxed text-sm">Longer appointments ensure thorough, unhurried care for every patient.</p>
            </div>
            <div className="group border border-[var(--gold)]/40 bg-[#faf9f7] p-8 text-center hover:border-[var(--gold)] hover:shadow-lg transition-all">
              <div className="w-16 h-16 mx-auto mb-6 rounded-full bg-[var(--navy)] flex items-center justify-center">
                <Sparkles className="w-8 h-8 text-white" strokeWidth={1.5} />
              </div>
              <h3 className="text-lg font-bold text-[var(--navy)] mb-4 leading-snug uppercase tracking-wide">Advanced Technology</h3>
              <p className="text-gray-600 leading-relaxed text-sm">AI-powered X-rays and modern equipment for better diagnostics and treatment.</p>
            </div>
            <div className="group border border-[var(--gold)]/40 bg-[#faf9f7] p-8 text-center hover:border-[var(--gold)] hover:shadow-lg transition-all">
              <div className="w-16 h-16 mx-auto mb-6 rounded-full bg-[var(--navy)] flex items-center justify-center">
                <Shield className="w-8 h-8 text-white" strokeWidth={1.5} />
              </div>
              <h3 className="text-lg font-bold text-[var(--navy)] mb-4 leading-snug uppercase tracking-wide">Family-Owned & Trusted</h3>
              <p className="text-gray-600 leading-relaxed text-sm">Lasting relationships built on trust and personalized care.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white">
        <div className="mx-auto max-w-6xl px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              <h2 className="text-3xl sm:text-4xl font-bold text-[var(--navy)]">Meet Dr. Bright</h2>
              <p className="text-gray-600 leading-relaxed">
                Dr. Bright is dedicated to providing comprehensive dental care with a focus on patient comfort and advanced technology. With years of experience in both general and cosmetic dentistry, he has built his practice around the principle that patients deserve longer appointment times, personalized treatment plans, and access to the latest dental technology.
              </p>
              <ul className="space-y-3">
                <li className="flex items-center gap-3">
                  <Star className="h-5 w-5 text-[var(--gold)] flex-shrink-0" />
                  <span className="text-gray-600">Fellow of the Academy of General Dentistry (FAGD)</span>
                </li>
                <li className="flex items-center gap-3">
                  <Star className="h-5 w-5 text-[var(--gold)] flex-shrink-0" />
                  <span className="text-gray-600">Associate Fellow, American Academy of Implant Dentistry</span>
                </li>
                <li className="flex items-center gap-3">
                  <Star className="h-5 w-5 text-[var(--gold)] flex-shrink-0" />
                  <span className="text-gray-600">500+ hours of continuing education</span>
                </li>
              </ul>
              <Link
                href="/about/dr-bright"
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-8">Ready to experience the Cherry Creek South Dental difference? Contact us to schedule your visit.</p>
